...
@section('content')
    ...
    @endif
    {{-- <a href="{{route('admin.crear.categoria')}}" class="crear-categoria-btn btn-danger btn mb-3" type="submit">Crear categoria</a> --}}
            ...
            <tbody>
                @foreach ($categorias as $categoria)
                    <tr>
                        ...
                        <td>
                            <a href="{{$categoria->id}}/delete" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a></div>
                        </td>
                    </tr>
                @endforeach
            </tbody>
